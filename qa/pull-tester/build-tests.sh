...
DISTDIR=pesetacoin-0.9.2

# Cross-compile for windows first (breaking the mingw/windows build is most common)
cd /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2
make distdir
mkdir -p win32-build
...
if [ -d "$OUT_DIR" -a -w "$OUT_DIR" ]; then
  set +e
  # Windows:
  cp /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/win32-build/src/bitcoind.exe $OUT_DIR/bitcoind.exe
  cp /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/win32-build/src/test/test_bitcoin.exe $OUT_DIR/test_bitcoin.exe
  cp /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/win32-build/src/qt/bitcoind-qt.exe $OUT_DIR/bitcoin-qt.exe
  # Linux:
  cp /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/linux-build/src/bitcoind $OUT_DIR/bitcoind
  cp /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/linux-build/src/test/test_bitcoin $OUT_DIR/test_bitcoin
  cp /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/linux-build/src/qt/bitcoind-qt $OUT_DIR/bitcoin-qt
  set -e
fi

# Run unit tests and blockchain-tester on Linux:
cd /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/linux-build
make check

# Run RPC integration test on Linux:
/mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/qa/rpc-tests/wallet.sh /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/linux-build/src
/mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/qa/rpc-tests/listtransactions.py --srcdir /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/linux-build/src
# Clean up cache/ directory that the python regression tests create
rm -rf cache

if [ $RUN_EXPENSIVE_TESTS = 1 ]; then
  # Run unit tests and blockchain-tester on Windows:
  cd /mnt/e08bbf2a-a458-4abd-9a74-8946934fec32/wallets/V2PTC/Pesetacoin-0.9.2/win32-build
  make check
fi
