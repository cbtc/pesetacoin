...
#define PACKAGE_BUGREPORT "info@pesetacoin.info"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Pesetacoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Pesetacoin Core 0.9.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "pesetacoin"
